...
from scriptaseq.util.scripts import invoke_user_script, UserScriptError
...
SCRIPTED_VAL_PROP_TYPE = PropType('Scripted Value', 'script = lambda: None', _string_conversion_func, True)
